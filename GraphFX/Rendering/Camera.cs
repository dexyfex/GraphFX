...
namespace GraphFX.Rendering
{
    public class Camera
    {
        ...
        public float DistanceMin = 0.000001f; //0.001mm min zoom dist...
        public float DistanceMax = 1000000.0f; //1000km max zoom dist
        ...
        public bool Is2DView = false;
        public bool IsOrthographic = false;
        public float OrthographicSize = 10.0f;
        public float OrthographicTargetSize = 10.0f;
        public float OrthographicSizeMin = 0.001f;
        public float OrthographicSizeMax = 1000000.0f;
        ...
        private void UpdateFollow(float elapsed)
        {
            ...
            if (TargetDistance > DistanceMax) TargetDistance = DistanceMax;
            if (TargetDistance < DistanceMin) TargetDistance = DistanceMin;
            ...
            if (IsOrthographic || Is2DView)
            {
                if (OrthographicTargetSize > OrthographicSizeMax) OrthographicTargetSize = OrthographicSizeMax;
                if (OrthographicTargetSize < OrthographicSizeMin) OrthographicTargetSize = OrthographicSizeMin;
            ...
            if (Is2DView)
            {
                ...
                Vector3 cpos = FollowPosition;// new Vector3();
        ...
        private void UpdateProjMatrix()
        {
            if (Is2DView)
            {
                ProjMatrix = Matrix.OrthoRH(AspectRatio * OrthographicSize, OrthographicSize, 3000.0f, 0.0f);
            }
